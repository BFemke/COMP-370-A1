...
public class PointCPD52Test
{
	public static void main(String[] args) throws IOException
	{
		...
		PointCPD52 pointA = getInput();
		PointCPD52 pointB = getInput();
	...
	/**
	   ...
	   *         the user.
	   */
	private static PointCPD52 getInput() throws IOException
	{
		Double min = 0.0;
		Double maxRho = 200.0;
		Double maxTheta = 360.0;
        ...
        return new PointCPD52(rho, theta);
